 ...
 * 1) Set a break point in KindePhpGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class KindePhpGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("kinde-php-sdk") // use this codegen library
              ...
              .setOutputDir("out/kinde-php-sdk"); // output directory
